...
def process_request(request):
    ...
    data = {
        ...
        "orgUnit": "DiszpKrYNg8",
        "dataValues": [
            {"dataElement":"MSZuQ1mTsia", "value": int(incoming_data[1])},
            {"dataElement":"FTRrcoaog83", "value": int(incoming_data[2])},
            {"dataElement":"Yy9NtNfwYZJ", "value": int(incoming_data[3])},
            {"dataElement":"eY5ehpbEsB7", "value": int(incoming_data[4])},
            {"dataElement":"Vp12ncSU1Av", "value": int(incoming_data[5])},
            {"dataElement":"f7n9E0hX8qk", "value": int(incoming_data[6])},
            {"dataElement":"USBq0VHSkZq", "value": int(incoming_data[7])},
            {"dataElement":"Ix2HsbDMLea", "value": int(incoming_data[8])},
            {"dataElement":"NpJtsQkMTm3", "value": int(incoming_data[9])},
            {"dataElement":"LjNlMTl9Nq9", "value": int(incoming_data[10])},
            {"dataElement":"r6nrJANOqMw", "value": int(incoming_data[11])},
            {"dataElement":"lXolhoWewYH", "value": int(incoming_data[12])},
            {"dataElement":"hM4ya5T2AqX", "value": int(incoming_data[13])},
            {"dataElement":"jVDAvs6kIAP", "value": int(incoming_data[14])}
        ],
    }
